...
def fun_with_ids
  ...
  # d_outer has the same id as a_outer. Ruby re-uses id's when the value is the same.
  ...
  1.times do
    ...
    # the id's remain the same inside the block as they are outside the block.
    ...
    # changing the values creates new objects (and id's) and assignes the values to the same variable names.
  ...
  # variables keep their new object/object_ids
  ...
  # these variables no longer have any meaning as they were definied withing the blocks inner scope.
end
